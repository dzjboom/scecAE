...
对数据进行预处理。保留
'''
def data_preprocess(adata: sc.AnnData, key: str='batch', n_top_genes: int=1000, flavor: str='seurat_v3', min_genes: int=200, min_cells: int=3, n_batch: int=2) -> sc.AnnData:
