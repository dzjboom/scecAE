...
##### check whether input is suitable for scecAe preprocessing #####
def checkInput(adata,batch_key,log):
    ...
    if batch_key is not None and batch_key not in adata.obs.columns:
        ...
        log.info("scecAe cretate \"BATCH\" column to set all cell to one batch!!!")
        batch_key="BATCH"
...
#######plot HeatMap with similarity calculated by scecAe ######
